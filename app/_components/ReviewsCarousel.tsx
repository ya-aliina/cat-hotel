...
const REVIEWS: Review[] = [
  {
    id: '1',
    text: 'Дуже задоволені! Котик повернувся спокійним і доглянутим. Дякуємо за турботу та щоденні фотозвіти.',
    author: 'Валерія Гришаєва',
    date: '15 березня 2026',
  },
  {
    id: '2',
    text: 'Чудовий готель. Дуже чисто, приємний персонал. Наш котик навіть не хотів їхати додому! Рекомендую.',
    author: 'Катерина Мінаєва',
    date: '10 березня 2026',
  },
  {
    id: '3',
    text: 'Залишали нашого Мурзіка на тиждень. Все пройшло чудово, ніякого стресу для тварини.',
    author: 'Павло Нечаєв',
    date: '1 березня 2026',
  },
  {
    id: '4',
    text: 'Найкращий готель для котів у місті. Ціни приємні, а сервіс на висоті. Тепер ми ваші постійні клієнти.',
...
export function ReviewsCarousel() {
  ...
  return (
    <section className="w-full relative overflow-hidden py-16 md:py-24">
      <div className="absolute top-[-30px] right-0 md:top-[-100px] md:right-[20px] lg:-right-[165px] z-[-1] w-[250px] md:w-[350px] lg:w-[420px] aspect-square pointer-events-none rotate-[-25deg]">
        <Image
          src="/paw.svg"
          alt="Декоративна лапка"
          fill
